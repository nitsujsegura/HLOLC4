    ...
    <?php 
     ...
     <div class="container mt-5">
         <div class="card" style="width: 22rem;">
          <img src="../img/student_<?=$student['gender']?>.png" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title text-center">@<?=$student['username']?></h5>
          </div>
          <ul class="list-group list-group-flush">
          <li class="list-group-item">LRN: <?=$student['lrn']?></li>
            ...
            <br><br>
            <li class="list-group-item">Guardian/Parent first name: <?=$student['guardian_parent_first_name']?></li>
            <li class="list-group-item">Guardian/Parent last name: <?=$student['guardian_parent_last_name']?></li>
            <li class="list-group-item">Guardian/Parent phone number: <?=$student['guardian_parent_phone_number']?></li>
          </ul>
          <div class="card-body">
